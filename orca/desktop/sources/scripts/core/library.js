...
library.a = function OperatorA (orca, x, y, passive) {
  ...
  this.ports.a = { x: -1, y: 0, default: '0' }
  this.ports.b = { x: 1, y: 0, default: '0' }
...
library.c = function OperatorC (orca, x, y, passive) {
  ...
  this.ports.rate = { x: -1, y: 0, clamp: { min: 1 }, default: '1' }
...
library.d = function OperatorD (orca, x, y, passive) {
  ...
  this.ports.rate = { x: -1, y: 0, clamp: { min: 1 }, default: '1' }
  this.ports.mod = { x: 1, y: 0, clamp: { min: 1 }, default: '8' }
...
library.g = function OperatorG (orca, x, y, passive) {
  ...
  this.ports.x = { x: -3, y: 0, default: '0' }
  this.ports.y = { x: -2, y: 0, default: '0' }
  this.ports.len = { x: -1, y: 0, clamp: { min: 1 }, default: '1' }
...
library.i = function OperatorI (orca, x, y, passive) {
  ...
  this.ports.mod = { x: 1, y: 0, default: 'z' }
...
library.o = function OperatorO (orca, x, y, passive) {
  ...
  this.ports.x = { x: -2, y: 0, default: '0' }
  this.ports.y = { x: -1, y: 0, default: '0' }
...
library.p = function OperatorP (orca, x, y, passive) {
  ...
  this.ports.key = { x: -2, y: 0, default: '0' }
  this.ports.len = { x: -1, y: 0, clamp: { min: 1 }, default: '1' }
  this.ports.val = { x: 1, y: 0, default: '0' }
...
library.r = function OperatorR (orca, x, y, passive) {
  ...
  this.ports.a = { x: -1, y: 0, default: '0' }
  this.ports.b = { x: 1, y: 0, default: 'z' }
  this.ports.output = { x: 0, y: 1, sensitive: true, output: true }
...
// added sigv anim
library['`'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '`', true)

  this.name = 'sigv'
  this.info = 'Sends sigv animation message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca a ' + path, msg)
...
library['|'] = function OperatorSigv (orca, x, y, passive) {
  ...
  this.name = 'sigv'
  this.info = 'Sends sigv material message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca m ' + path, msg)
...
// added sigv transform
library['^'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '^', true)

  this.name = 'sigv'
  this.info = 'Sends sigv ramped transform message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca t ' + path, msg)
...
// added sigv aio audio engine
library['_'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '_', true)

  this.name = 'sigv'
  this.info = 'Sends sigv audio message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca > ' + path, msg)
...
// added sigv lights
library['º'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, 'º', true)

  this.name = 'sigv'
  this.info = 'Sends sigv lighting message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca l ' + path, msg)
...
// added sigv system operator
library['…'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '…', true)

  this.name = 'sigv'
  this.info = 'Sends sigv system message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca y ' + path, msg)
...
// added sigv serial operator
library['∆'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '∆', true)

  this.name = 'sigv'
  this.info = 'Sends sigv serial message'
...
// added sigv sampler
library['ß'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, 'ß', true)

  this.name = 'sigv'
  this.info = 'Sends sigv buffer message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca b ' + path, msg)
...
// added sigv lz operator
library['∞'] = function OperatorSigv (orca, x, y, passive) {
  Operator.call(this, orca, x, y, '∞', true)

  this.name = 'sigv'
  this.info = 'Sends sigv lz message'
  ...
  this.operation = function (force = false) {
    ...
    this.draw = false
    client.io.osc.push('/sigv orca c ' + path, msg)
